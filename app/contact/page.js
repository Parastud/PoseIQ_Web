...
export const metadata = {
  title: "Contact Us - Pose-IQ",
  description: "Get in touch with the Pose-IQ team for support, sales inquiries, or general questions",
};
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">hello@pose-iq.com</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">support@pose-iq.com</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">docs.pose-iq.com</p>
                      </div>
                    </div>
                  </div>
                </div>
